...
const SectionSnake = ({ className, post, }: Props) => {
  const postHref = getPathFromSlugAndType(post.slug, "post")
  return (
    <div className={`${className} flex md:flex-col lg:flex-row space-x-4 md:space-x-0 lg:space-x-4`}>
      ...
      <div className="flex-[2] md:flex-1 lg:flex-[2]">
