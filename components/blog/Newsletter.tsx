const Newsletter = () => {
  return (
    <form onSubmit={(e) => { e.preventDefault() }} className="my-24 relative py-12 px-4 sm:px-0 max-w-xl border mx-auto border-blue-700 rounded-md text-center">
      ...
      <p className="text-xl font-semibold">Get my best posts in your inbox</p>
      <div className="flex flex-col sm:flex-row justify-center mt-4">
        ...
        <button className="mt-2 sm:mt-0 bg-blue-700 text-white py-1 px-4 ml-0 focus:outline-none focus:bg-blue-800">Subscribe</button>
      </div>
    </form>
  )
}
