...
const Codepen = ({ url, title = "codepen" }: Props) => {
  ...
  if (!codepenUser || !codepenHash) return (
    <div className="flex justify-center items-center text-base border mt-8 border-gray-400 text-center" style={{ width: "100%", height: "400px", }}>
  ...
  return (
    <div className="mt-8">
      <iframe height="600" style={{ width: "100%", }} scrolling="no" title={title} src={`https://codepen.io/${codepenUser}/embed/${codepenHash}`} frameBorder="no" loading="lazy" allowTransparency={true} allowFullScreen={true}>
