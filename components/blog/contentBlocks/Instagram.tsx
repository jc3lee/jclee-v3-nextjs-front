...
function getInstaId(url = "") {
  ...
  if (!instaSegment) return {}
  const instaSegmentArr = instaSegment.split("/")
  if (instaSegmentArr.length < 3) return {}
  const instaId = instaSegmentArr[2]
  return {
    instaId,
  }
}
