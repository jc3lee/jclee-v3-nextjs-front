...
const ItemDesc = ({ className, item, cart, setCart, handleAddedToCart }: Props) => {
  ...
  return (
    <div className={className}>
      ...
      <button onClick={handleAddToCartBtnClick} className="text-sm mt-8 uppercase tracking-wider w-96 py-3.5 max-w-full text-blue-900 border border-blue-800 rounded-sm font-bold ">Add to Cart</button>
